...
if(isset($_GET['id']))
{
	...
	if(!isset($row['id']))
	{
		...
		header('location:manager.php?inc=addeditnews&message='.$error);
		exit;
	}	
	$name = $row['name'];
	$content = $row['content'];
...
?>
<div class="col-md-12">
	<br /><a href="manager.php?inc=managenews" class="btn btn-primary">Back</a>
	<h3>Add/edit news</h3>
</div>
<div class="col-md-12">
	...
	if(file_exists($dir))
	{
		if(count(scandir($dir)) > 0)
		{
			...
			$u->echoeol('<h4>Files available for news</h4>');
  ...
  <div class="modal-dialog">
    <div class="modal-content">
		...
		<div class="modal-body">
			<form action="formhandler.php?action=news/addnewsimage" method="POST" enctype="multipart/form-data" id="addfile">
				<input type="hidden" name="id" value="<?php echo $id; ?>" />
				<div class="form-group">
					<label for="newsfile">File</label>
