<base href="<?php echo $c->getVal('url').$status; ?>">
<link rel="canonical" href="<?php echo $c->getVal('url').$status; ?>" />
<link type="text/plain" rel="author" href="<?php echo $c->getVal('url'); ?>humans.txt" />
